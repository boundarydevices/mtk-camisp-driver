...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.ar0830ap1302d2l = {
		.width_factor = AR0830AP1302D2L_SLAVE_SENSOR_COUNT,
	},
};
...
static void preview_setting(struct subdrv_ctx *ctx)
{
	...
	ar0830ap1302d2l_config_mode(&imgsensor_info.ar0830ap1302d2l, &info);
}   /*  preview_setting  */
...
static int open(struct subdrv_ctx *ctx)
{
	...
	ar0830ap1302d2l_sensor_init(&imgsensor_info.ar0830ap1302d2l);
	// request firmware
	LOG_INFO("AR0830AP1302D2L request fw.");
	ret = ar0830ap1302d2l_request_firmware(&imgsensor_info.ar0830ap1302d2l);
	if (ret) {
		LOG_ERR("AR0830AP1302D2L Request Firmware Failed.");
		release_firmware(imgsensor_info.ar0830ap1302d2l.fw);
		return ret;
	}
	for (retries = 0; retries < 5; ++retries) {
		LOG_DBG("Try to load f/w. AR0830AP1302D2L LINE = %d.", __LINE__);
		ret = ar0830ap1302d2l_load_firmware(&imgsensor_info.ar0830ap1302d2l);
		if (!ret)
			break;
		//ar0830ap1302d2l_log_status(&imgsensor_info.ar0830ap1302d2l);
		ar0830ap1302d2l_reset(&imgsensor_info.ar0830ap1302d2l);
...
static int close(struct subdrv_ctx *ctx)
{
	...
	//release_firmware(imgsensor_info.ar0830ap1302d2l.fw);
	ar0830ap1302d2l_remove(&imgsensor_info.ar0830ap1302d2l);
	return ERROR_NONE;
} /* close  */
...
static kal_uint32 streaming_control(struct subdrv_ctx *ctx, kal_bool enable)
{
	...
	if (enable) {
		ar0830ap1302d2l_stream(&imgsensor_info.ar0830ap1302d2l, enable);
		...
		struct i2c_client *i2c_client, u8 i2c_write_id)
{
	...
	// add for AR0830AP1302D2L
	imgsensor_info.ar0830ap1302d2l.dev = &i2c_client->dev;
	imgsensor_info.ar0830ap1302d2l.client = i2c_client;
	imgsensor_info.ar0830ap1302d2l.ctx = ctx;
	return 0;
}
